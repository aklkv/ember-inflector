import { pluralize } from '../lib/system/string.js';
...
function pluralizeHelper(...args) {
  ...
  if (args.length === 2) {
    const [count, word] = args;
    return pluralize(count, word, {
      withoutCount: named['without-count']
    });
  }
  const [word] = args;
...
export { pluralizeHelper as default };
